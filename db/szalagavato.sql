...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Sze 24. 07:46
...
(63, 'Mezei Dániel', 'M', 0, 'MezeiDaniel.jpg', '13B', 185),
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `last_name`, `first_name`, `phone`, `description`) VALUES
(1, 'Badó-Gulácsi Dániel', 'badogulacsi.daniel-2021@keri.mako.hu', 'badogulacsidaniel13c', 'Badó-Gulácsi', 'Dániel', '', ''),
(2, 'Berta Barnabás', 'berta.barnabas-2021@keri.mako.hu', 'bertabarnabas13c', 'Berta', 'Barnabás', '', ''),
(3, 'Bokor Richárd', 'bokor.richard-2021@keri.mako.hu', 'bokorrichard13c', 'Bokor', 'Richárd', '', ''),
(4, 'Dani Benedek', 'dani.benedek-2021@keri.mako.hu', 'danibenedek13c', 'Dani', 'Benedek', '', ''),
(5, 'Döme Zoltán', 'dome.zoltan-2021@keri.mako.hu', 'domezoltan13c', 'Döme', 'Zoltán', '', ''),
(6, 'Esser Balázs Dávid', 'esser.balazs-2021@keri.mako.hu', 'esserbalazsdavid13c', 'Esser', 'Balázs Dávid', '', ''),
(7, 'Fodor Adrián László', 'fodor.adrian-2021@keri.mako.hu', 'fodoradrianlaszlo13c', 'Fodor', 'Adrián László', '', ''),
(8, 'Guvat Bence József', 'guvat.bence-2021@keri.mako.hu', 'guvatbencejozsef13c', 'Guvat', 'Bence József', '', ''),
(9, 'Herczeg Máté János', 'herczeg.mate-2021@keri.mako.hu', 'herczegmatejanos13c', 'Herczeg', 'Máté János', '', ''),
(10, 'Kardos Zoltán', 'kardos.zoltan-2021@keri.mako.hu', 'kardoszoltan13c', 'Kardos', 'Zoltán', '', ''),
(11, 'Kis David Csaba', 'kis.david-2021@keri.mako.hu', 'kisdavidcsaba13c', 'Kis', 'David Csaba', '', ''),
(12, 'Kis Marcell Zsombor', 'kis.marcell-2021@keri.mako.hu', 'kismarcellzsombor13c', 'Kis', 'Marcell Zsombor', '', ''),
(13, 'Knoch Henrik', 'knoch.henrik-2021@keri.mako.hu', 'knochhenrik13c', 'Knoch', 'Henrik', '', ''),
(14, 'Kriván Balázs', 'krivan.balazs-2021@keri.mako.hu', 'krivanbalazs13c', 'Kriván', 'Balázs', '', ''),
(15, 'Kulcsár Tamás Ámon', 'kulcsar.tamas-2021@keri.mako.hu', 'kulcsartamasamon13c', 'Kulcsár', 'Tamás Ámon', '', ''),
(16, 'Miklós Martin', 'miklos.martin-2021@keri.mako.hu', 'miklosmartin13c', 'Miklós', 'Martin', '', ''),
(17, 'Oláh Zsigmond Sámuel', 'olah.zsigmond-2021@keri.mako.hu', 'olahzsigmondsamuel13', 'Oláh', 'Zsigmond Sámuel', '', ''),
(18, 'Répa Norbert', 'repa.norbert-2021@keri.mako.hu', 'repanorbert13c', 'Répa', 'Norbert', '', ''),
(19, 'Sötét Ármin', 'sotet.armin-2021@keri.mako.hu', 'sotetarmin13c', 'Sötét', 'Ármin', '', ''),
(20, 'Suba Benjamin', 'suba.benjamin-2021@keri.mako.hu', 'subabenjamin13c', 'Suba', 'Benjamin', '', ''),
(21, 'Suhajda Ádám Dominik', 'suhajda.adam-2021@keri.mako.hu', 'suhajdaadamdominik13', 'Suhajda', 'Ádám Dominik', '', ''),
(22, 'Szabó Bence', 'szabo.bence-2021@keri.mako.hu', 'szabobence13c', 'Szabó', 'Bence', '', ''),
(23, 'Szalontai László', 'szalontai.laszlo-2021@keri.mako.hu', 'szalontailaszlo13c', 'Szalontai', 'László', '', ''),
(24, 'Szántó Péter', 'szanto.peter-2021@keri.mako.hu', 'szantopeter13c', 'Szántó', 'Péter', '', ''),
(25, 'Tokai Ádám', 'tokai.adam-2021@keri.mako.hu', 'tokaiadam13c', 'Tokai', 'Ádám', '', ''),
(26, 'Tóth László Gábor', 'toth.laszlo-2021@keri.mako.hu', 'tothlaszlogabor13c', 'Tóth', 'László Gábor', '0620ha', 'Calippo123'),
(27, 'Andor Rebeka', 'andor.rebeka-2021@keri.mako.hu', 'andorrebeka13a', 'Andor', 'Rebeka', '', ''),
(28, 'Baróczi Gergő', 'baroczi.gergo-2021@keri.mako.hu', 'baroczigergo13a', 'Baróczi', 'Gergő', '', ''),
(29, 'Berta Sztella', 'berta.sztella-2021@keri.mako.hu', 'bertasztella13a', 'Berta', 'Sztella', '', ''),
(30, 'Boros Balázs', 'boros.balazs-2021@keri.mako.hu', 'borosbalazs13a', 'Boros', 'Balázs', '', ''),
(31, 'Derdák Csenge', 'derdak.csenge-2021@keri.mako.hu', 'derdakcsenge13a', 'Derdák', 'Csenge', '', ''),
(32, 'Erdélián Iringó', 'erdelian.iringo-2021@keri.mako.hu', 'erdelianiringo13a', 'Erdélián', 'Iringó', '', ''),
(33, 'Faragó Zorka', 'farago.zorka-2021@keri.mako.hu', 'faragozorka13a', 'Faragó', 'Zorka', '', ''),
(34, 'Gregor Lilla', 'gregor.lilla-2021@keri.mako.hu', 'gregorlilla13a', 'Gregor', 'Lilla', '', ''),
(35, 'Horváth Zoé', 'horvath.zoe-2021@keri.mako.hu', 'horvathzoe13a', 'Horváth', 'Zoé', '', ''),
(36, 'Jankó Georgina', 'janko.georgina-2021@keri.mako.hu', 'jankogeorgina13a', 'Jankó', 'Georgina', '', ''),
(37, 'Kerekes Ákos', 'kerekes.akos-2021@keri.mako.hu', 'kerekesakos13a', 'Kerekes', 'Ákos', '', ''),
(38, 'Kis-Jakab Péter', 'kisjakab.peter-2021@keri.mako.hu', 'kisjakabpeter13a', 'Kis-Jakab', 'Péter', '', ''),
(39, 'Kocka Kira', 'kocka.kira-2021@keri.mako.hu', 'kockakira13a', 'Kocka', 'Kira', '', ''),
(40, 'Kovács Dorka', 'kovacs.dorka-2021@keri.mako.hu', 'kovacsdorka13b', 'Kovács', 'Dorka', '', ''),
(41, 'Kovács Lara', 'kovacs.lara-2021@keri.mako.hu', 'kovacslara13a', 'Kovács', 'Lara', '', ''),
(42, 'Lenhardt Ákos', 'lenhardt.akos-2021@keri.mako.hu', 'lenhardtakos13a', 'Lenhardt', 'Ákos', '', ''),
(43, 'Mágori Adél', 'magori.adel-2021@keri.mako.hu', 'magoriadel13a', 'Mágori', 'Adél', '', ''),
(44, 'Mészáros Anna', 'meszaros.anna-2021@keri.mako.hu', 'meszarosanna13a', 'Mészáros', 'Anna', '', ''),
(45, 'Nagy Kristóf', 'nagy.kristof-2021@keri.mako.hu', 'nagykristof13a', 'Nagy', 'Kristóf', '', ''),
(46, 'Savanya Réka Gabriella', 'savanya.reka-2021@keri.mako.hu', 'savanyarekagabriella', 'Savanya', 'Réka Gabriella', '', ''),
(47, 'Schneider Evelyn', 'schneider.evelyn-2021@keri.mako.hu', 'schneiderevelyn13a', 'Schneider', 'Evelyn', '', ''),
(48, 'Szabó Jázmin', 'szabo.jazmin-2021@keri.mako.hu', 'szabojazmin13a', 'Szabó', 'Jázmin', '', ''),
(49, 'Szabó Kata', 'szabo.kata-2021@keri.mako.hu', 'szabokata13a', 'Szabó', 'Kata', '', ''),
(50, 'Velek Panna', 'velek.panna-2021@keri.mako.hu', 'velekpanna13a', 'Velek', 'Panna', '', ''),
(51, 'Vetró Barbara', 'vetro.barbara-2021@keri.mako.hu', 'vetrobarbara13a', 'Vetró', 'Barbara', '', ''),
(52, 'Vincze Kinga Jázmin', 'vincze.kinga-2021@keri.mako.hu', 'vinczekingajazmin13a', 'Vincze', 'Kinga Jázmin', '', ''),
(53, 'Zatykó Lili', 'zatyko.lili-2021@keri.mako.hu', 'zatykolili13a', 'Zatykó', 'Lili', '', ''),
(54, 'Bálint Cintia', 'balint.cintia-2021@keri.mako.hu', 'balintcintia13b', 'Bálint', 'Cintia', '', ''),
(55, 'Czékmán Lili', 'czekman.lili-2021@keri.mako.hu', 'czekmanlili13b', 'Czékmán', 'Lili', '', ''),
(56, 'Csige Evelin', 'csige.evelin-2021@keri.mako.hu', 'csigeevelin13b', 'Csige', 'Evelin', '', ''),
(57, 'Ferencsik Vivien', 'ferencsik.vivien-2021@keri.mako.hu', 'ferencsikvivien13b', 'Ferencsik', 'Vivien', '', ''),
(58, 'Gyenge Iván', 'gyenge.ivan-2021@keri.mako.hu', 'gyengeivan13b', 'Gyenge', 'Iván', '', ''),
(59, 'Illés Imre Dániel', 'illes.imre-2021@keri.mako.hu', 'illesimredaniel13b', 'Illés', 'Imre Dániel', '', ''),
(60, 'Joó Nóra', 'joo.nora-2021@keri.mako.hu', 'joonora13b', 'Joó', 'Nóra', '', ''),
(61, 'Loós Jázmin', 'loos.jazmin-2021@keri.mako.hu', 'loosjazmin13b', 'Loós', 'Jázmin', '', ''),
(62, 'Mak Szilvia', 'mak.szilvia-2021@keri.mako.hu', 'makszilvia13b', 'Mak', 'Szilvia', '', ''),
(63, 'Mezei Dániel', 'mezei.daniel-2021@keri.mako.hu', 'mezeidaniel13b', 'Mezei', 'Dániel', '', ''),
(64, 'Pásztor Tímea', 'pasztor.timea-2021@keri.mako.hu', 'pasztortimea13b', 'Pásztor', 'Tímea', '', ''),
(65, 'Pepó Gábor', 'pepo.gabor-2021@keri.mako.hu', 'pepogabor13b', 'Pepó', 'Gábor', '', ''),
(66, 'Szécsi Dóra', 'szecsi.dora-2021@keri.mako.hu', 'szecsidora13b', 'Szécsi', 'Dóra', '', ''),
(67, 'Sztojkó Lara', 'sztojko.lara-2021@keri.mako.hu', 'sztojkolara13b', 'Sztojkó', 'Lara', '', ''),
(68, 'Varadik Armand', 'varadik.armand-2021@keri.mako.hu', 'varadikarmand13b', 'Varadik', 'Armand', '', ''),
(69, 'Dombi Ivett', 'dombi.ivett-2021@keri.mako.hu', 'dombiivett13a', 'Dombi', 'Ivett', '', ''),
(70, 'Ambrózy Vanda', 'ambrozy.vanda-2021@keri.mako.hu', 'ambrozyvanda13a', 'Ambrózy', 'Vanda', '', ''),
(999, 'admin ', 'admin@gmail.com', 'admin123', 'admin', '', '', '');
